...
#
# Brief description:
# This script launches a 
#
# --------------------------------
# ROBUST ESTIMATOR
# --------------------------------
# Guan et al. (2025) developed the ‘robust estimator’ that uses only the 
# random variation in offspring genotype given parental genotype, 
# which is the principle underlying the properties of FGWAS with fully 
# observed parental genotypes.
#
...
IMP_DIR="${INPUT_ROOT}/03_mendelian-imputation"
...
OUTPUT_ROOT="/Users/Roberto/01_results/01_gwas-sumstats/02_fgwas-snipar-topmed_phased/02_robust-estimator"
...
IMP_FILE="${IMP_DIR}/op_prefix_chr${CHR}.shapeit5_ligated.high-quality.parental_genotypes.hdf5"
...
# Job name
JOB_NAME="FGWAS (robust-estimator) ${PHENO} (chr_${CHR_PADDED})"
...
dx run app-swiss-army-knife \
    ...
    gwas.py '${PHENO}.qc-phenotype.txt' \
      ...
      --imp 'op_prefix_chr@.shapeit5_ligated.high-quality.parental_genotypes' \
      --chr_range ${CHR} \
